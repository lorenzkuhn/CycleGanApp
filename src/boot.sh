...
exec gunicorn --workers=5 --timeout 120 -b 0.0.0.0:8080 --access-logfile gunicorn_access.log --error-logfile gunicorn_error.log --log-level=info --capture-output application_server:app
